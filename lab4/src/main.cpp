...
int main(int argc, char **argv) {
  ...
  try {
    ...
    std::cout << "Loaded " << tspaInstance.getTotalNodes() << " nodes from "
              << tspaFilePath << std::endl;
    std::cout << std::endl;
    ...
    // SolverStatistics rsStats =
    //     SolverRunner::runAllStartingPoints(randomSearchSolver, tspaInstance);
    // printAndVisualize("Random Search", rsStats);
    //
    // SolverStatistics nnaStats =
    //     SolverRunner::runAllStartingPoints(nearestNeighbourAny,
    //     tspaInstance);
    // printAndVisualize("Nearest Neighbour Any", nnaStats);
    //
    // SolverStatistics nnStats =
    //     SolverRunner::runAllStartingPoints(nearestNeighbour, tspaInstance);
    // printAndVisualize("Nearest Neighbour Simple", nnStats);
    //
    // SolverStatistics nncCycleStats =
    //     SolverRunner::runAllStartingPoints(nearestNeighbourCycle,
    //     tspaInstance);
    // printAndVisualize("Nearest Neighbour Cycle", nncCycleStats);
    //
    // SolverStatistics nncStats =
    //     SolverRunner::runAllStartingPoints(kRegretCycleSolver, tspaInstance);
    // printAndVisualize("Cycle K-Regret", nncStats);
    //
    // SolverStatistics nn2rStats = SolverRunner::runAllStartingPoints(
    //     nearestNeighbour2Regret, tspaInstance);
    // printAndVisualize("Nearest Neighbour 2-Regret", nn2rStats);
    //
    // kRegretCycleWeighted kRegretCycleWeightedSolver;
    // SolverStatistics krcwStats = SolverRunner::runAllStartingPoints(
    //     kRegretCycleWeightedSolver, tspaInstance);
    // printAndVisualize("Cycle K-Regret Weighted", krcwStats);
    //
    // NearestNeighbour2RegretWeighted nearestNeighbour2RegretWeighted;
    // SolverStatistics nn2rwStats = SolverRunner::runAllStartingPoints(
    //     nearestNeighbour2RegretWeighted, tspaInstance);
    // printAndVisualize("Nearest Neighbour 2-Regret Weighted", nn2rwStats);
    //
    // LocalGreedy LSRandomNodeSolver(LocalGreedy::StartingStrategy::Random,
    //                                LocalGreedy::IntraMode::NodeExchange);
    // SolverStatistics lgStats =
    //     SolverRunner::runAllStartingPoints(LSRandomNodeSolver, tspaInstance);
    // printAndVisualize("Local Greedy Node", lgStats);
    //
    // LocalGreedy LSRandomEdgeSolver(LocalGreedy::StartingStrategy::Random,
    //                                LocalGreedy::IntraMode::EdgeExchange);
    // SolverStatistics lgEdgeStats =
    //     SolverRunner::runAllStartingPoints(LSRandomEdgeSolver, tspaInstance);
    // printAndVisualize("Local Greedy Edge", lgEdgeStats);
    //
    // LocalGreedy
    // LSHeuristicNodeSolver(LocalGreedy::StartingStrategy::Heuristic,
    //                                   LocalGreedy::IntraMode::NodeExchange);
    // SolverStatistics lgHeuNodeStats =
    //     SolverRunner::runAllStartingPoints(LSHeuristicNodeSolver,
    //     tspaInstance);
    // printAndVisualize("Local Greedy Heuristic Node", lgHeuNodeStats);
    //
    // LocalGreedy
    // LSHeuristicEdgeSolver(LocalGreedy::StartingStrategy::Heuristic,
    //                                   LocalGreedy::IntraMode::EdgeExchange);
    // SolverStatistics lgHeuEdgeStats =
    //     SolverRunner::runAllStartingPoints(LSHeuristicEdgeSolver,
    //     tspaInstance);
    // printAndVisualize("Local Greedy Heuristic Edge", lgHeuEdgeStats);
    //
    // LocalSteepest
    // LSStRandomNodeSolver(LocalSteepest::StartingStrategy::Random,
    //                                    LocalSteepest::IntraMode::NodeExchange);
    // SolverStatistics lstats =
    //     SolverRunner::runAllStartingPoints(LSStRandomNodeSolver,
    //     tspaInstance);
    ...
    printAndVisualize("Neighbour Steepes Edge", nsatsEdge);

    // LocalSteepest LSStHeuristicNodeSolver(
    //     LocalSteepest::StartingStrategy::Heuristic,
    //     LocalSteepest::IntraMode::NodeExchange);
    // SolverStatistics lstatsHeuNode = SolverRunner::runAllStartingPoints(
    //     LSStHeuristicNodeSolver, tspaInstance);
    // printAndVisualize("Local Steepest Heuristic Node", lstatsHeuNode);
    //
    // LocalSteepest LSStHeuristicEdgeSolver(
    //     LocalSteepest::StartingStrategy::Heuristic,
    //     LocalSteepest::IntraMode::EdgeExchange);
    // SolverStatistics lstatsHeuEdge = SolverRunner::runAllStartingPoints(
    //     LSStHeuristicEdgeSolver, tspaInstance);
